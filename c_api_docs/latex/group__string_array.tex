...
\subsubsection[{get\+Number\+Of\+String\+Elements(const R\+R\+String\+Array\+Ptr list)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C int rrc\+Call\+Conv get\+Number\+Of\+String\+Elements (
...
\subsubsection[{get\+String\+Element(\+R\+R\+String\+Array\+Ptr list, int index)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C char$\ast$ rrc\+Call\+Conv get\+String\+Element (
\begin{DoxyParamCaption}
