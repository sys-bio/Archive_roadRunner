...
\begin{DoxyCompactList}\small\item\em Global parameter that holds the last error, if any. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Global parameter that holds the C A\+P\+I install folder. \end{DoxyCompactList}\item 
