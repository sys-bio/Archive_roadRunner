...
\subsubsection[{create\+Text(const char $\ast$text)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C char$\ast$ rrc\+Call\+Conv create\+Text (
...
\subsubsection[{create\+Text\+Memory(const int count)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C char$\ast$ rrc\+Call\+Conv create\+Text\+Memory (
\begin{DoxyParamCaption}
...
\subsubsection[{get\+File\+Content(const char $\ast$f\+Name)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C char$\ast$ rrc\+Call\+Conv get\+File\+Content (
\begin{DoxyParamCaption}
