...
\subsubsection[{compile\+Source(\+R\+R\+Handle handle, const char $\ast$source\+File\+Name\+And\+Path)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C bool rrc\+Call\+Conv compile\+Source (
...
\subsubsection[{create\+R\+R\+Matrix(int r, int c)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C {\bf R\+R\+Double\+Matrix\+Ptr} rrc\+Call\+Conv create\+R\+R\+Matrix (
\begin{DoxyParamCaption}
\item[{int}]{r, }
\item[{int}]{c}
\end{DoxyParamCaption}
...
\subsubsection[{create\+Vector(int size)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C {\bf R\+R\+Vector\+Ptr} rrc\+Call\+Conv create\+Vector (
\begin{DoxyParamCaption}
\item[{int}]{size}
\end{DoxyParamCaption}
...
\subsubsection[{get\+Complex\+Matrix\+Element(\+R\+R\+Complex\+Matrix\+Ptr m, int r, int c, R\+R\+Complex\+Ptr value)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C bool rrc\+Call\+Conv get\+Complex\+Matrix\+Element (
\begin{DoxyParamCaption}
...
\subsubsection[{get\+Matrix\+Element(\+R\+R\+Double\+Matrix\+Ptr m, int r, int c, double $\ast$value)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C bool rrc\+Call\+Conv get\+Matrix\+Element (
\begin{DoxyParamCaption}
...
\subsubsection[{get\+Matrix\+Num\+Cols(\+R\+R\+Double\+Matrix\+Ptr m)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C int rrc\+Call\+Conv get\+Matrix\+Num\+Cols (
\begin{DoxyParamCaption}
\item[{{\bf R\+R\+Double\+Matrix\+Ptr}}]{m}
\end{DoxyParamCaption}
...
\subsubsection[{get\+Matrix\+Num\+Rows(\+R\+R\+Double\+Matrix\+Ptr m)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C int rrc\+Call\+Conv get\+Matrix\+Num\+Rows (
\begin{DoxyParamCaption}
\item[{{\bf R\+R\+Double\+Matrix\+Ptr}}]{m}
\end{DoxyParamCaption}
...
\subsubsection[{get\+R\+R\+C\+Data\+Element(\+R\+R\+C\+Data\+Ptr rr\+Data, int r, int c, double $\ast$value)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C bool rrc\+Call\+Conv get\+R\+R\+C\+Data\+Element (
\begin{DoxyParamCaption}
...
\subsubsection[{get\+R\+R\+Data\+Column\+Label(\+R\+R\+C\+Data\+Ptr rr\+Data, int column)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C char$\ast$ rrc\+Call\+Conv get\+R\+R\+Data\+Column\+Label (
\begin{DoxyParamCaption}
\item[{{\bf R\+R\+C\+Data\+Ptr}}]{rr\+Data, }
\item[{int}]{column}
\end{DoxyParamCaption}
...
\subsubsection[{get\+R\+R\+Data\+Num\+Cols(\+R\+R\+C\+Data\+Ptr rr\+Data)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C int rrc\+Call\+Conv get\+R\+R\+Data\+Num\+Cols (
\begin{DoxyParamCaption}
\item[{{\bf R\+R\+C\+Data\+Ptr}}]{rr\+Data}
\end{DoxyParamCaption}
...
Retrieve the number of columns in the given rr\+Data data (returned form \hyperlink{group__simulation_ga9ac99f6909eb0a6244035fc9cdeff94d}{simulate(\+R\+R\+Handle handle)}) 
...
\subsubsection[{get\+R\+R\+Data\+Num\+Rows(\+R\+R\+C\+Data\+Ptr rr\+Data)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C int rrc\+Call\+Conv get\+R\+R\+Data\+Num\+Rows (
\begin{DoxyParamCaption}
\item[{{\bf R\+R\+C\+Data\+Ptr}}]{rr\+Data}
\end{DoxyParamCaption}
...
Retrieve the number of rows in the given Road\+Runner numerical data (returned from \hyperlink{group__simulation_ga9ac99f6909eb0a6244035fc9cdeff94d}{simulate(\+R\+R\+Handle handle)}) 
...
\subsubsection[{get\+Vector\+Element(\+R\+R\+Vector\+Ptr vector, int index, double $\ast$value)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C bool rrc\+Call\+Conv get\+Vector\+Element (
\begin{DoxyParamCaption}
...
\subsubsection[{get\+Vector\+Length(\+R\+R\+Vector\+Ptr vector)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C int rrc\+Call\+Conv get\+Vector\+Length (
\begin{DoxyParamCaption}
\item[{{\bf R\+R\+Vector\+Ptr}}]{vector}
\end{DoxyParamCaption}
...
\subsubsection[{set\+Complex\+Matrix\+Element(\+R\+R\+Complex\+Matrix\+Ptr m, int r, int c, R\+R\+Complex\+Ptr value)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C bool rrc\+Call\+Conv set\+Complex\+Matrix\+Element (
\begin{DoxyParamCaption}
\item[{{\bf R\+R\+Complex\+Matrix\+Ptr}}]{m, }
\item[{int}]{r, }
\item[{int}]{c, }
...
\subsubsection[{set\+Matrix\+Element(\+R\+R\+Double\+Matrix\+Ptr m, int r, int c, double value)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C bool rrc\+Call\+Conv set\+Matrix\+Element (
\begin{DoxyParamCaption}
\item[{{\bf R\+R\+Double\+Matrix\+Ptr}}]{m, }
\item[{int}]{r, }
\item[{int}]{c, }
...
\subsubsection[{set\+Vector\+Element(\+R\+R\+Vector\+Ptr vector, int index, double value)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C bool rrc\+Call\+Conv set\+Vector\+Element (
\begin{DoxyParamCaption}
\item[{{\bf R\+R\+Vector\+Ptr}}]{vector, }
\item[{int}]{index, }
\item[{double}]{value}
...
\subsubsection[{write\+R\+R\+Data(\+R\+R\+Handle handle, const char $\ast$file\+Name\+And\+Path)}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+D\+E\+C\+L\+\_\+\+S\+P\+E\+C bool rrc\+Call\+Conv write\+R\+R\+Data (
\begin{DoxyParamCaption}
\item[{{\bf R\+R\+Handle}}]{handle, }
